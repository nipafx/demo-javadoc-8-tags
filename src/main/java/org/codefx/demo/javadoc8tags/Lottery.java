...
public interface Lottery {
	 ...
	 *
	 * @apiNote This method was added after the interface was released. It is defined as a default method for
	 *          compatibility reasons. From version 1.2 on, the method will be abstract and all implementations of this
	 *          interface have to provide their own implementation of the method.
